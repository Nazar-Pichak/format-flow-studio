...
import { Upload, FilePlus, FileVideo } from 'lucide-react';
    ...
    >
      ...
      {fileName ? (
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h3 className="text-lg font-medium mt-2">Upload your video</h3>
          <p className="text-sm text-muted-foreground max-w-xs">Drag and drop your video file here or click to browse</p>
          <button 
            onClick={handleButtonClick}
